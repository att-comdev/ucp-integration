...
export UCP_INTEGRATION_REFSPEC="refs/changes/03/404203/28"
...
All of these documents are now placed into the /root/deploy/site direectory
for ease of use - instructions are provided by the script at the end of a
successful genesis process.