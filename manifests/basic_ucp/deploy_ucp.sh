...
export MAAS_REGION_IMAGE=${MAAS_CACHE_IMAGE:-"quay.io/attcomdev/maas-region:master"}
export MAAS_RACK_IMAGE=${MAAS_CACHE_IMAGE:-"quay.io/attcomdev/maas-rack:master"}
