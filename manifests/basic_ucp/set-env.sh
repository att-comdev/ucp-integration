...
export DECKHAND_IMAGE=quay.io/attcomdev/deckhand:master
export DECKHAND_CHART_REPO=https://github.com/att-comdev/aic-helm
export DECKHAND_CHART_BRANCH=master
export SHIPYARD_IMAGE=quay.io/attcomdev/shipyard:master
export SHIPYARD_CHART_REPO=https://github.com/att-comdev/aic-helm
export SHIPYARD_CHART_BRANCH=master
export AIRFLOW_IMAGE=docker.io/eanylin/airflow-helm:1.8.1-1.6.8-v0.6.0
